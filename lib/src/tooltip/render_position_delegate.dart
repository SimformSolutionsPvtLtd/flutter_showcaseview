...
class _RenderPositionDelegate extends RenderBox
  ...
  // Add these properties to _RenderPositionDelegate class
  ...
  void _initializeLayout() {
    ...
    _availableScreenWidth = screenSize.width - (2 * screenEdgePadding);
    _availableScreenHeight = screenSize.height - (2 * screenEdgePadding);
  ...
  void _normalizeWidths() {
    ...
    if (actionBoxManager != null && tooltipBoxManager != null) {
